 ...
 * English marks (marks is between 0 to 100 and if it is out of range print error message ΓÇ£Invalid
 * Input, Marks should between 0 to 100ΓÇ¥) and find out total, percentage and result.
